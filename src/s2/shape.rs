...
pub fn sort_edges(e: &mut Vec<Edge>) {
    e.sort()
}
...
mod tests {
    ...
    #[test]
    fn test_edge_implementation() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        assert_eq!(edge1.v0, Point::from_coords(-101.744384, 39.32155, 0.));
        assert_eq!(edge1.v1, Point::from_coords(-101.552124, 39.330048, 0.));
    }

    #[test]
    fn test_edge_cmp_less_than_other_edge() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        let edge2 = Edge {
            v0: Point::from_coords(-101.403808, 39.330048, 0.),
            v1: Point::from_coords(-101.332397, 39.364032, 0.),
        };
        assert_eq!(Ordering::Less, edge1.cmp(&edge2));
    }

    #[test]
    fn test_edge_cmp_greater_than_other_edge() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        ...
        assert_eq!(Ordering::Greater, edge2.cmp(&edge1));
    }

    #[test]
    fn test_edge_cmp_equal_to_other_edge() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        ...
        assert_eq!(Ordering::Equal, edge1.cmp(&edge2));
    }

    #[test]
    fn test_edge_eq_true() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        ...
        assert_eq!(true, edge1.eq(&edge2));
    }

    #[test]
    fn test_edge_eq_false() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        ...
        assert_eq!(false, edge2.eq(&edge1));
    }

    fn test_partial_cmp(v1: &Edge, v2: &Edge, expected: Ordering) {
        assert_eq!(v1.partial_cmp(&v2), Some(expected));
    }

    #[test]
    fn test_edge_partial_cmp() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        ...
        test_partial_cmp(&edge1, &edge2, Ordering::Less);
        test_partial_cmp(&edge1, &edge1, Ordering::Equal);
        test_partial_cmp(&edge2, &edge1, Ordering::Greater);
    }
    ...
    fn test_edge_sort() {
        ...
        assert_eq!(vec.len(), 2);
        assert_eq!(vec[0], edge2);

        sort_edges(&mut vec);

        assert_eq!(vec[0], edge1);
        assert_eq!(vec, vec![edge1, edge2]);
    }

    #[test]
    fn test_edges_implementation() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        ...
        vec.push(edge2);
        vec.push(edge1);
        let edges1: Edges = vec;
        assert_eq!(edges1[0], edge2);
        assert_eq!(edges1[1], edge1);
    }

    #[test]
    fn test_edges_less_true() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        ...
        vec.push(edge1);
        let edges1: Edges = vec;
        assert_eq!(true, edges1.less(1, 0));
    }

    #[test]
    fn test_edges_less_false() {
        let edge1 = Edge {
            v0: Point::from_coords(-101.744384, 39.32155, 0.),
            v1: Point::from_coords(-101.552124, 39.330048, 0.),
        };
        ...
        vec.push(edge1);
        let edges1: Edges = vec;
        assert_eq!(false, edges1.less(0, 1));
    }

    #[test]
    fn test_shapeedgeid_implementation() {
        let shapeedgeid1 = ShapeEdgeID {
            shape_id: 0,
            edge_id: 20,
        };
        assert_eq!(shapeedgeid1.shape_id, 0);
        assert_eq!(shapeedgeid1.edge_id, 20);
    }

    #[test]
    fn test_shapeedgeid_cmp_less_than_other_shapeedgeid() {
        let shapeedgeid1 = ShapeEdgeID {
            shape_id: 0,
            edge_id: 20,
        };
        let shapeedgeid2 = ShapeEdgeID {
            shape_id: 20,
            edge_id: 20,
        };
        assert_eq!(-1, shapeedgeid1.cmp(shapeedgeid2));
    }

    #[test]
    fn test_shapeedgeid_cmp_greater_than_other_shapeedgeid() {
        let shapeedgeid1 = ShapeEdgeID {
            shape_id: 10,
            edge_id: 20,
        };
        ...
        assert_eq!(1, shapeedgeid2.cmp(shapeedgeid1));
    }

    #[test]
    fn test_shapeedgeid_cmp_equal_to_other_shapeedgeid() {
        let shapeedgeid1 = ShapeEdgeID {
            shape_id: 10,
            edge_id: 20,
        };
        ...
        assert_eq!(0, shapeedgeid1.cmp(shapeedgeid2));
    }

    #[test]
    fn test_origin_reference_point() {
        let refpoint: ReferencePoint = origin_reference_point(true);
        assert_eq!(refpoint.point, Point::origin());
    }
